        ...
        <div className={styles['buy-box-container']}>
          ...
          <div className={styles['reassurance-container']}>
            <div className={styles['payement-icons-container']}>
              <Image src="/icons/paypal-icon.png" alt="Paypal Icon" width={50} height={50} />
              <Image src="/icons/visa-icon.png" alt="Visa Icon" width={50} height={50} />
              <Image src="/icons/mastercard-icon.png" alt="MasterCard Icon" width={50} height={50} />
            </div>
